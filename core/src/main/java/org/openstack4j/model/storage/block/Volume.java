...
public interface Volume extends ModelEntity, Buildable<VolumeBuilder> {
	 ...
	 */
	public enum Status {
		AVAILABLE, ATTACHING,DETACHING, BACKING_UP, CREATING, DELETING, DOWNLOADING, UPLOADING, ERROR, ERROR_DELETING, ERROR_RESTORING, IN_USE, RESTORING_BACKUP, UNRECOGNIZED;
